...
public class SavingsCalculator {
    public static void display(){
        ...
        calStage.setTitle("Savings Calculator");
        ...
        // Creating labels
        Label lblHeader = new Label("Savings Calculator");
        ...
        Label lblMonthlyPaymentLeft = new Label("Monthly Payment");
        ...
        txtMonthlyPayment.setPromptText("$");
        ...
        calculate.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                TextField[] textFields = {txtPrincipal, txtPeriod, txtInterestRate, txtMonthlyPayment, txtFutureValue};
                double[] values = Validate.validateInputsForSavings(textFields);
                String[] strValues = new String[values.length];
                switch ((int)values[values.length-2]) {
                    case 0:
                        lblError.setText("");
                        strValues = Calculate.calculateForSavings(values);

                        String []historyKeys = {lblPrincipalRight.getText(), lblPeriodRight.getText(),lblInterestRateRight.getText(), lblMonthlyPayRight.getText(), lblFutureValueRight.getText()};
                        History.addToHistory(historyKeys, strValues, "Savings");
                        break;
                    case 1:
                ...
                lblAnswerMonthlyPay.setText(strValues[3]);
                lblAnswerFutureValue.setText(strValues[4]);
        ...
        GridPane.setConstraints(lblMonthlyPaymentLeft,1,5);
        GridPane.setConstraints(lblFutureValueLeft,1,6);

        GridPane.setConstraints(txtPrincipal,2,2);
        GridPane.setConstraints(txtPeriod,2,3);
        GridPane.setConstraints(txtInterestRate,2,4);
        GridPane.setConstraints(txtMonthlyPayment,2,5);
        GridPane.setConstraints(txtFutureValue,2,6);
        ...
        GridPane.setConstraints(lblMonthlyPayRight,6,5);
        GridPane.setConstraints(lblFutureValueRight,6,6);
        ...
        GridPane.setConstraints(lblAnswerMonthlyPay,7,5);
        GridPane.setConstraints(lblAnswerFutureValue,7,6);
        ...
        txtMonthlyPayment.setOnMouseClicked(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                Keyboard.currentTxtField = txtMonthlyPayment;
                Keyboard.typeInTxtField();
            }
        });
        ...
        autoLoan.getChildren().addAll(back, btnVBox, lblHeader, lblPrincipalLeft,lblPeriodLeft, lblInterestRateLeft, lblMonthlyPaymentLeft, lblFutureValueLeft);
        autoLoan.getChildren().addAll(txtPrincipal, txtPeriod, txtInterestRate, txtMonthlyPayment, txtFutureValue);
        autoLoan.getChildren().addAll(lblPrincipalRight, lblPeriodRight, lblInterestRateRight, lblMonthlyPayRight, lblFutureValueRight, lblError);
        autoLoan.getChildren().addAll(lblAnswerPrincipal, lblAnswerPeriod, lblAnswerInterestRate, lblAnswerMonthlyPay, lblAnswerFutureValue);
