...
public class MortgageCalculator {
    public static void display(){
        ...
        calStage.setTitle("Mortgage Calculator");
        ...
        // Creating labels
        Label lblHeader = new Label("Mortgage Calculator");
        lblHeader.setId("header");

        Label lblPrincipalLeft = new Label("Home Principal");
        ...
        Label lblPrincipalRight = new Label("Home Principal");
            ...
            public void handle(ActionEvent event) {
                ...
                switch ((int)values[values.length-2]) {
                    case 0:
                        ...
                        History.addToHistory(historyKeys, strValues, "Mortgage");
                        break;
                    case 1:
